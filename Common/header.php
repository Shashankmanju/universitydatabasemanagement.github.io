...
<head>
	...
	<link rel="shortcut icon" href="./Images/bp.png" type="image/x-icon">
...
<nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
	<a class="navbar-brand d-flex align-items-center" href="index.php">
		<img src="images/download.png" class="logo-image" width="50" height="50">
		<h3 class="text-light text-uppercase ml-2">NIT College</h3>
	</a>
	...
	<div class="collapse navbar-collapse" id="navbarNavDropdown">
		<ul class="navbar-nav ml-auto">
			...
			<!-- <li class="nav-item active">
				<a class="nav-link" href="index1.php">ABOUT US<span class="sr-only">(current)</span></a>
			</li> -->
